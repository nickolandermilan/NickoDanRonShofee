            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "images/shoe4.jpg" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "images/shoe4.jpg"></div>
                        
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Nike Sneaker</span>
                    ...
                    <p><a href="cart-add.php?id=12" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    } else {
