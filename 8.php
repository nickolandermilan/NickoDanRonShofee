            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "images/shirt4.jpg" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "images/shirt4.jpg"></div>
                       
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">GUCCI White t-Shirt</span>
                    ...
                    <p><a href="cart-add.php?id=8" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    } else {
